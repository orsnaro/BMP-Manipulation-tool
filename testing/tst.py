...
# gray_manual = np.zeros((rgb6.shape[0] , rgb6.shape[1]) , dtype= np.uint8)
# gray_manual = (rgb6[:,:,0] + rgb6[:,:,1] + rgb6[:,:,2] ) / 3 #in one line numpy !!! common at least 10 lines in cpp
# cv2.imshow("gry_man" , gray_manual)
